...
#WorldInfo.slb-active .world_entry .slb-entry-header-shell{grid-template-columns:auto minmax(0,1fr) max-content!important;column-gap:4px!important;padding-right:4px!important;overflow:visible!important}
#WorldInfo.slb-active .world_entry .slb-header-toggles{grid-column:1!important}
#WorldInfo.slb-active .world_entry .slb-header-grid{grid-column:2!important;grid-template-columns:minmax(120px,1fr) 54px 118px 38px 50px 68px!important;column-gap:4px!important;width:100%!important;min-width:0!important;max-width:100%!important}
#WorldInfo.slb-active .world_entry .slb-mobile-entry-state-badge{display:none!important}
#WorldInfo.slb-active .world_entry .slb-header-actions{grid-column:3!important;display:flex!important;flex:0 0 max-content!important;width:max-content!important;min-width:max-content!important;max-width:none!important;justify-self:end!important;gap:3px!important;padding:0!important;overflow:visible!important}
#WorldInfo.slb-active .world_entry .slb-strategy-field>select,#WorldInfo.slb-active .world_entry .slb-position-field>select{text-align:center!important;text-align-last:center!important;padding-inline:4px!important}
#WorldInfo.slb-active .world_entry .slb-depth-field>input,#WorldInfo.slb-active .world_entry .slb-order-field>input,#WorldInfo.slb-active .world_entry .slb-trigger-field>input{text-align:center!important;padding-inline:2px!important}
}
