...
#WorldInfo.slb-active .world_entry .slb-header-grid{grid-template-columns:minmax(140px,1fr) minmax(52px,68px) minmax(100px,132px) minmax(38px,48px) minmax(48px,56px) minmax(60px,76px)!important;column-gap:6px!important;width:100%!important;min-width:0!important;max-width:100%!important}
