...
#WorldInfo.slb-active.slb-mobile-entry-state-enabled .world_entry.slb-compact-entry .slb-entry-header-shell,#WorldInfo.slb-active.slb-mobile-entry-state-enabled .world_entry .slb-entry-header-shell,#WorldInfo.slb-active .world_entry .slb-entry-header-shell{grid-template-columns:auto minmax(0,828px) max-content!important;justify-content:start!important;column-gap:4px!important;padding-right:4px!important;overflow:visible!important}
...
#WorldInfo.slb-active.slb-mobile-entry-state-enabled .world_entry.slb-compact-entry .slb-entry-header-shell>.slb-header-actions,#WorldInfo.slb-active.slb-mobile-entry-state-enabled .world_entry .slb-entry-header-shell>.slb-header-actions,#WorldInfo.slb-active .world_entry .slb-entry-header-shell>.slb-header-actions{grid-column:3!important;grid-row:1!important;display:flex!important;flex:0 0 max-content!important;width:max-content!important;min-width:max-content!important;max-width:none!important;justify-self:end!important;gap:3px!important;padding:0!important;overflow:visible!important}
